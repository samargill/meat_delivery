							...
							<table id="MyDataTable" class="table table-bordered table-hover" style="min-width:800px;">
								<thead>
									<tr>
										...
										<th width="9%"  style="text-align:left;"  >Mobile No</th>
										<th width="12%" style="text-align:left;"  >Mobile Name</th>
										<th width="10%"  style="text-align:center;">Dev Status</th>
										<!-- <th width="7%"  style="text-align:center;">App Ver</th>
										<th width="11%" style="text-align:center;">Connect</th> -->
										<th width="9%"  style="text-align:center;">Max Slot</th>
										<th width="9%" style="text-align:center;">Used Slot</th>
								...
								<tbody>
									<?php
										...
										$QuerySelect = "SELECT CM.clientmobid, C.clientname, CM.mobileno, CM.mobilecode,".
											" CM.mobilename, CM.appversion, CM.token, CM.lastconnect, CM.adddate, CM.lastedit";
										$QueryJoin = "".
										...
										while ($objRow = mysqli_fetch_object($rstRow))
										{
											...
											if ($objRow->token != "")
												...
												$DeviceStatus = "";
											if ($objRow->appversion > 0.00)
												$AppVersion = $objRow->appversion;
											else
												$AppVersion = "";
											if ($objRow->lastconnect == null)
												$LastConnect = "";
											else
												$LastConnect = ShowDate($objRow->lastconnect,4);
									?>
									<tr id="Row<?php echo($Index);?>">
										...
										<td align="center"><?php echo($AppVersion);?></td>
										<td align="center"><?php echo($LastConnect);?></td>
