							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php
											DBCombo("cboPackage","package","pkgid","pkgname","WHERE status = 1 AND ispkg = 1",$cboPackage,"--- Show All ---","form-control select2","style=\"width: 100%;\"");
										?>
									</div>
								</div>
								<div class="col-md-4">
							...
							<table id="MyDataTable" class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th width="14%" style="text-align:left;" >Order Date</th>
										<th width="18%" style="text-align:left;" >Client Name</th>
										<th width="14%" style="text-align:left;" >Package</th>
										<th width="12%" style="text-align:left;" >Contact #</th>
										<th width="12%" style="text-align:left;" >Pay Type</th>
										<th width="12%" style="text-align:left;" >Pay Charges</th>
										<th width="12%" style="text-align:left;">Package Amount</th>
									</tr>
								</thead>
								<tbody>
									<?php
									...
									<tr id="Row<?php echo($Index);?>">
										...
										<td align="left"><?php echo(ShowDate($objRow->orderdate,0));?></td>
