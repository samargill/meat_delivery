<?php
	$PageID = array(array(5,1,0),array(5,2,0),array(10,1,0),array(10,2,0));
	$PagePath = "../../";
	$PageTitle= "Add User";
	...
	if (isset($_REQUEST["btnSave"]))
	{
		...
		$Query = "SELECT ".$AdminID." FROM ".$Table."".
			" WHERE ".$AdminID." = ".$SessionID." AND email = '".$_REQUEST['txtEmail']."'";
		if ($UserID > 0)
		{
		...
		if ($UserID == 0)
		{
			...
			{
				$UserID = GetMax("adminlogin","adminid");
				$Query = "INSERT INTO adminlogin".
					" (adminid, addby, admintype, firstname, mobile, email, password, adddate, status)".
					" VALUES (".$UserID.", ".$_SESSION[SessionID."Admin"].", ".$_REQUEST['cboClientType'].",".
					" '".TrimText($_REQUEST['txtName'],1)."', '".$_REQUEST['txtMobile']."',".
					" '".$_REQUEST['txtEmail']."', '".password_hash($_REQUEST['txtPassword'],PASSWORD_DEFAULT)."', NOW(), 1)";
			}	
		}	
		else
		{
			...
			else
			{
				...
				{
				$Query .= "".
					" admintype = ".$_REQUEST['cboClientType'].",";
				}
				$Query .= "".
					"  firstname = '".$_REQUEST['txtName']."'".
					", mobile = '".$_REQUEST['txtMobile']."'".
					", email  = '".$_REQUEST['txtEmail']."'";
				if (strlen($_REQUEST['txtPassword']) > 0)
				{
				...
				$Query .= "".
					", lastedit     = NOW()".
					"  WHERE adminid = ".$UserID." AND addby = ".$_SESSION[SessionID."Admin"];
			}
		}
						...
						<div class="card-body">
							...
							<?php
								...
								else
								{
									...
									$Query = "SELECT ".$Name." As UserName, email, password, mobile, ".$User."type As UserType".
										" FROM ".$Table." WHERE ".$User."id= ".$UserID;	
