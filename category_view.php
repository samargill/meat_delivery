		...
		<section class="content">
			<div class="container-fluid">
				<div class="card card-outline card-primary">
					<form name="Form" role="form" action="category_view" method="post">
						<div class="card-body">
							<div class="row">
								<div class="col-md-4">
							...
							<div class="row mb-2">
								...
								<div class="col-md-4">
									<button type="button" name="btnAddCategory" id="btnAddCategory" class="btn btn-success" onclick="AddRecord();">
										<i class="fa fa-plus"></i> &nbsp; Add New Category
									</button>
								</div>
							</div>
							<table id="MyDataTable" class="table table-bordered table-hover" style="min-width:800px; width: 100%;">
								<thead>
									<tr>
										...
										<th width="22%" style="text-align:center;">Status</th>
...
<script>
	...
	function AddRecord()
	{
		var Win = Popup("category_add","NC_HalalMeat_Edit",740,1024,100,100);
		Win.focus();
	}

	function EditRecord(CategoryID)
	{
		var Win = Popup("category_add?CategoryID="+CategoryID,"NC_HalalMeat_Edit",740,1024,100,100);
		Win.focus();
	}

	function DeleteRecord(CategoryID,Index)
	{
		<?php CheckRight("Delete","ShowError"); ?>
		var DelStatus = "fas fa-trash-alt";
		$.confirm({
			columnClass: 'col-md-6 col-md-offset-3',
			content: function () {
				var self = this;
				return $.ajax({
					url: "../ajax/category/category_delete",
					dataType: "JSON",
					method: 'POST',
					data: {
			...
			buttons: {
				"confirm": {
					...
					keys: ['enter'],
					action: function() {
						DeleteRecordApply(CategoryID,Index,DelStatus);
					}
				},
				"cancel": {
					text: "No",
	...
	function DeleteRecordApply(CategoryID,Index,Status)
	{
		var Flag = "";
		$.confirm({
			content: function () {
