...
<script>
	...
	function AddRecord()
	{
		var Win = Popup("category_add","KS_MeatDelivery_Edit",740,1024,100,100);
		Win.focus();
	}

	function EditRecord(CategoryID)
	{
		var Win = Popup("category_add?CategoryID="+CategoryID,"KS_MeatDelivery_Edit",740,1024,100,100);
		Win.focus();
	}
	...
	function DeleteRecord(CategoryID,Index)
	{
		...
		$.confirm({
			...
			content: function () {
				var self = this;
				return $.ajax({
					url: "../ajax/category/del-category",
					dataType: "JSON",
					method: 'POST',
					data: {
