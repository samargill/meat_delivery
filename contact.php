...
<head>
    ...
    <!--leaflet map-->
    <link rel="stylesheet" href="assets/js/leaflet%401.7.1/dist/leaflet.css" integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==" crossorigin="">
    <script src="assets/js/leaflet%401.7.1/dist/leaflet.js" integrity="sha512-XQoYMqMTK8LvdxXYG3nZ448hOEQiglfqkJs1NOQV44cWnUrBc8PkAOcXy20w0vlaXaVUearIOBhiXZ5V3ynxwA==" crossorigin=""></script>
</head>
                        ...
                        <section class="mb-50">
                            <div class="row mb-60">
                                <div class="col-md-4 mb-4 mb-md-0">
                                    ...
                                    <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a6c5c9c8d2c7c5d2e6e3d0c7d4c788c5c9cb">[email&#160;protected]</a><br>
                                ...
                                <div class="col-md-4 mb-4 mb-md-0">
                                    ...
                                    Chicago, 60601, USA<br>
                                    <abbr title="Phone">Phone:</abbr> (123) 456-7890<br>
                                    <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a7c4c8c9d3c6c4d3e7e2d1c6d5c689c4c8ca">[email&#160;protected]</a><br>
                                    <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i class="fi-rs-marker mr-5"></i>View map</a>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    Chicago, 60601, USA<br>
                                    <abbr title="Phone">Phone:</abbr> (123) 456-7890<br>
                                    <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="12717d7c667371665257647360733c717d7f">[email&#160;protected]</a><br>
                                    <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i class="fi-rs-marker mr-5"></i>View map</a>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email: </strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__">admin@meatdlv.com</a></span></li>
